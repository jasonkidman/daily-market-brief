...
2) 泛网络安全事件：黑客组织活动、政府网站攻击、国家间网络攻击、僵尸网络、网络安全执法行动默认排除；例外仅限于：直接涉及上文重点科技公司；或已造成明确、实质性的商业影响（例如导致停产、数据泄露赔偿、股价重大反应等已发生的事实）；或明确影响美国关键基础设施/上市公司并具有市场意义。缺乏这类具体证据的网络安全新闻（例如某国网络攻击、僵尸网络域名查封等，即使受害机构包括政府部门）应排除。
3) 中国国内政策新闻：继续默认排除，除非该政策直接影响上文重点科技公司或美国上市公司，且传导关系明确、具体。
4) 泛国际新闻：与美国宏观经济、美国金融市场、重点科技公司均没有明确关系的新闻默认排除。

先判断事件本身是否值得入选，不得根据当天市场涨跌反向寻找新闻，不得根据标普或纳指当天表现倒推新闻，也不得因为某事件容易做投资分析而提高其入选概率。来源质量不等于事件重要性，高等级来源只用于可信度、冲突判断和同事件代表文章选择。

事实确认门槛：“今日重要新闻”优先只包含过去24小时内真实发生、已经确认、具有明确新信息的事件。每个入选候选都必须能明确回答“新发生了什么”：例如新政策、新经济数据、新监管行动、新公司重大行动、新地缘政治进展、新金融市场系统性事件，或新的、已被可靠来源确认的重要科技发布/事件。纯评论、专栏、观点或分析文章，如果没有披露独立新闻价值的新事实、政策、数据、公司行动或事件进展，不得仅因观点具有市场意义而入选。例外：Fed 主席、FOMC 票委及其他核心央行决策者就利率路径、通胀判断、加息/降息条件、QT/QE 或资产负债表发表的公开表态，视为 macro_policy 事实信号，不因其形式是"讲话/表态"而被当作普通评论排除；仍需满足本段其余事实确认要求（非重复报道、非未确认传闻）。未确认传闻、网络猜测、匿名模型或产品猜测不得入选；社交媒体热度、讨论广度或市场叙事不能替代可靠事实确认。
...
美国市场相关性是硬门槛，而不是软排序信号。每一条入选新闻至少必须满足以下一项：可能影响美国金融市场定价；可能影响美国宏观政策、利率、通胀或就业预期；可能影响主要美股上市公司或重要行业板块；可能实质改变 AI、半导体、云计算、数据中心或能源等关键产业格局；属于重大地缘政治事件且存在明确的市场传导渠道；或属于全球性金融、能源或贸易事件并对美国资产存在明显外溢影响。如果新闻只是“属于财经新闻”，但无法解释为什么值得美国市场投资者今天关注，则淘汰。此硬门槛适用于主线 A；主线 B（重点科技公司的实质性事件）改为满足上文「大型科技公司独立重要性标准」，不适用本段的市场传导硬门槛。

对每一条候选执行以下硬判断："Would a U.S. equity / rates / macro investor reasonably care about this development today?" If the answer is no, exclude it. 优先选择具有明确因果传导路径的事件：event → market / macro / industry variable → U.S. asset prices or major listed companies。如果这条路径弱、猜测性强、过于间接或只是“行业继续发展”，则排除。不得通过夸大 why_it_matters、假设连锁后果或虚构传导路径把弱新闻包装成重要新闻。此硬判断同样只适用于主线 A（macro_policy、financial_markets、geopolitics，以及不涉及重点科技公司的 high_tech 事件）；主线 B 的重点科技公司事件不需要通过这一测试，只需满足「大型科技公司独立重要性标准」。
...
不得通过夸大 why_it_matters、假设连锁后果或虚构传导路径把弱新闻包装成重要新闻。重大事件优先展示，但不要求精确的第1、第2、第3名；rank 仅作为展示顺序编号。若两个事件重要性接近，优先影响范围更广、持续时间更长、对美国宏观/金融体系/关键科技产业有更大外溢性的事件。
...
主题与集中度
同一 topic_group 通常最多4条。重大独立事件允许突破，但突破必须说明理由，并在 selection_reason 中包含“主题上限例外”及其独立系统性影响；不得为凑数突破主题上限。
