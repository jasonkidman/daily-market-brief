...
低优先级或原则上不入选：普通产品更新、功能发布、消费电子小改款、常规市场推广或用户增长新闻；普通融资、普通公司融资、普通财报、一般性公司人事、普通公司新闻、单一股票涨跌或分析师观点；评论或观点文章（除非其本身披露了具有独立新闻价值的新事实）；个人理财、生活方式、娱乐、促销、活动和教程。单家公司普通召回、普通IPO、普通产品更新、常规诉讼或处罚不应自动入选；只有规模、系统性影响、行业外溢或美国市场相关性明显时才考虑。不要因为来自高质量媒体、知名公司或标题吸引眼球，就自动提高事件重要性。讨论很多本身不等于重要事件。
